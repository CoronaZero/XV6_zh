...
> 来源：book-rev7.pdf，第 93–95 页（中文翻译）
> 说明：索引为术语检索表，条目（代码符号、函数名与英文术语）保留英文原样，便于对照原文与代码检索。
...
malloc, 10 controller (PIC), 40 struct inode, 74
...
page table entries (PTE), 25 SEG_TSS, 22 ticks, 50
